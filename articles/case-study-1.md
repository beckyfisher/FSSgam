...
a principal components analysis (PCA), making it was impossible to tease
...
complex reefs with small overhangs and caves (Polunin & Roberts 1993).
...
relationships (Froese & Pauly 2011).
...
Predictor correlations {.table style="width:100%;"}
...
Across functional feeding groups, reef structural complexity
consistently emerged as a dominant predictor of both abundance and
biomass. Management zoning effects were comparatively weaker, although
some responses showed interactions between habitat structure and zoning.
