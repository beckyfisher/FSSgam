...
106.8, 111.5 and 111.5 published, against 13.0, 62.5, 105.5, 108.4 and 109.6 here), which is
enough to exchange the fifth and sixth rows. The difference is attributable to changes in
`mgcv` and R since 2018 rather than to `FSSgam`: running this code against `FSSgam` 1.0.0
and against the current development version on the same R and `mgcv` gives identical values
for every one of the 52 candidate models.
