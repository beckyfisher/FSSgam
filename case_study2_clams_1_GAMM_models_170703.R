...
work.dir=("~/Dropbox/FSS_paper") # for Tim's mac
 # work.dir=("C:/Users/rfisher/Dropbox/FSS_paper/")

tidy.data=paste(work.dir,"case_study_TL clams/Data",sep="/")
model.out=paste(work.dir,"case_study_TL clams/ModelOut",sep="/")
script.dir=paste(work.dir)


# Load functions----
setwd(script.dir)
dir()
source("function_full_subsets_gam_v1.11.R")
source("function_check_correlations_v1.00.R")
