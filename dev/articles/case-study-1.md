...
AICc differs by a median of 0.66 and a maximum of 2.47 units. The
top-ranked model is the same as the published one for all eight
responses, and the R2 and edf values agree to the precision at which
they were published.
