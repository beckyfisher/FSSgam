...
full.subsets.gam=function(use.dat,test.fit,pred.vars.cont,pred.vars.fact=NA,
  ...
  # test.fit - a gam model fitted via a call to gam (mgcv) uGamm (MuMIn).
  #         This can use any of the
  #          (preferably continuous) predictors in the call and will be used
  #          as a model to update in the fitting of the model set.
  #          This must contain the appropriate
